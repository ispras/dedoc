...
class TestApiImageRefs(AbstractTestApiDocReader):
    def test_docx_with_images(self):
        ...
        self.assertTrue({'start': -1, 'end': -1, 'name': 'image', 'value': 'image1.png'} in image_annotations)

        image_paragraph = content["subparagraphs"][4]
        image_annotations = image_paragraph["annotations"]
        self.assertTrue({'start': -1, 'end': -1, 'name': 'image', 'value': 'image3.jpeg'} in image_annotations)

        image_paragraph = content["subparagraphs"][8]
        image_annotations = image_paragraph["annotations"]
        self.assertTrue({'start': -1, 'end': -1, 'name': 'image', 'value': 'image4.jpeg'} in image_annotations)

        image_paragraph = content["subparagraphs"][10]
        image_annotations = image_paragraph["annotations"]
        self.assertTrue({'start': -1, 'end': -1, 'name': 'image', 'value': 'image5.jpeg'} in image_annotations)
        self.assertTrue({'start': -1, 'end': -1, 'name': 'image', 'value': 'image6.jpeg'} in image_annotations)

        image_paragraph = content["subparagraphs"][11]
        image_annotations = image_paragraph["annotations"]
        self.assertTrue({'start': -1, 'end': -1, 'name': 'image', 'value': 'image7.jpeg'} in image_annotations)
    ...
    def test_odt_with_images(self):
        ...
        image_paragraph = content["subparagraphs"][1]
        image_annotations = image_paragraph["annotations"]
        self.assertTrue({'start': -1, 'end': -1, 'name': 'image', 'value': 'image1.jpeg'} in image_annotations)

        image_paragraph = content["subparagraphs"][8]
        image_annotations = image_paragraph["annotations"]
        self.assertTrue({'start': -1, 'end': -1, 'name': 'image', 'value': 'image2.jpeg'} in image_annotations)
    ...
    def test_docx_with_images_from_mac(self):
        ...
        image_annotations = image_paragraph["annotations"]
        self.assertTrue({'start': -1, 'end': -1, 'name': 'image', 'value': 'image3.png'} in image_annotations)
