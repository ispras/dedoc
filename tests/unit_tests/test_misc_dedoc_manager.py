...
class TestDedocManager(TestCase):
    """
    Class with implemented tests for DedocManager
    """
    ...
    def test_parse_file(self) -> None:
        """
        Tests .tsv file parsing correctness
        """
