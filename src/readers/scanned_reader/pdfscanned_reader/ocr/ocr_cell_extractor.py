...
from src.readers.scanned_reader.table_recognizer.table_utils.utils import get_highest_pixel_frequency, \
    get_cell_text_by_ocr
from src.utils.image_utils import crop_image_text
