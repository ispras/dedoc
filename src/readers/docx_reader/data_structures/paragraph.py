...
from src.readers.docx_reader.data_structures.run import Run
...
from src.readers.docx_reader.properties_extractor import change_paragraph_properties, change_run_properties
