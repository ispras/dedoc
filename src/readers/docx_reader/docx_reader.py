...
from src.attachments_extractors.concrete_attachments_extractors.docx_attachments_extractor import DocxAttachmentsExtractor
...
from src.readers.docx_reader.data_structures.docx_document import DocxDocument
