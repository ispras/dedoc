...
from src.extensions import converted_extensions, converted_mimes
...
class PNGConverter(AbstractConverter):
    ...
    def can_convert(self, extension: str, mime: str, parameters: Optional[dict] = None) -> bool:
        return extension in converted_extensions.image_like_format or mime in converted_mimes.image_like_format
